...
- Header nav order must be:
  ...
  2. `/war/` - War Room
  3. `/about/` - About
  4. `/work/` - Work With Me (if applicable)
  5. `/blog/` - Blog (if applicable)
...
## CSS
- Shared CSS lives in `/assets/site.css` (when created)
- Pages should load it with `<link rel="stylesheet" href="/assets/site.css">`
